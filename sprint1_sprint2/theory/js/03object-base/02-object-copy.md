...
![name value in user object](2022-05-09-18-25-21.png)
...
![name called by reference to admin and user object ](2022-05-09-18-26-25.png)
...
자바스크립트 라이브러리 `lodash`의 메서드인 `_.cloneDeep(obj)`을 사용하면 이 알고리즘을 직접 구현하지 않고도 깊은 복사를 처리할 수 있으므로 참고하시기 바랍니다.
